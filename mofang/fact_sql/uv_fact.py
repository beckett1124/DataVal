...
def uv_sql(tb, sql, rtb_list, d_date, pa_list):
    """
    ...
    if len(rtb_list) == 3:
        if 'ap' not in rtb_list:
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,count(distinct did) as uv from %s where bid = %s and year = \'%s\' " \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,count(distinct did) as uv from %s where bid = %s and " \
                ...
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,hour,count(distinct did) as uv from %s where bid = %s and year = \'%s\' " \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,hour,count(distinct did) as uv from %s where bid = %s and " \
        ...
        if 'ap' not in rtb_list:
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                ...
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,hour,count(distinct did) as uv from %s where bid = %s and " \
            ...
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,country,province,count(distinct did) as uv from %s where bid = %s and " \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,country,province,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s" \
                              % (rtb_list[1], fact_table, bid_val, str(d_date[1:5]), str(d_date[5:7]),
                                 str(d_date[7:-1]), rtb_list[1], any_val)
                ...
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,country,province,hour,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and hour = \'%s\'"\
                              % (fact_table, bid_val, str(d_date[1:5]), str(d_date[5:7]),
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,country,province,hour,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and hour = \'%s\' " \
                              "and %s = %s" \
                              % (rtb_list[1], fact_table, bid_val, str(d_date[1:5]), str(d_date[5:7]),
                                 str(d_date[7:9]), str(d_date[9:-1]), rtb_list[1], any_val)
            ...
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                              ...
                              % (rtb_list[2], rtb_list[3], fact_table, bid_val, str(d_date[1:5]), str(d_date[5:7]),
                                 str(d_date[7:-1]), rtb_list[2], bny_val, rtb_list[3], cny_val)
                    f_sql_e = "group by bid,%s,%s order by bid,%s,%s asc;" \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s and %s = %s" \
                              " and %s = %s" \
                ...
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,hour,count(distinct did) as uv from %s where bid = %s and " \
            ...
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,country,province,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s and %s = %s" \
                              % (rtb_list[1], rtb_list[2], fact_table, bid_val, str(d_date[1:5]), str(d_date[5:7]),
                                 str(d_date[7:-1]), rtb_list[1], any_val, rtb_list[2], bny_val)
                ...
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,country,province,hour,count(distinct did) as uv from %s " \
            ...
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                              ...
                              % (rtb_list[2], rtb_list[3], rtb_list[4], fact_table, bid_val,
                                 str(d_date[1:5]), str(d_date[5:7]), str(d_date[7:-1]), rtb_list[2],
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s and %s = %s" \
                              " and %s = %s and %s = %s" \
                ...
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,hour,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and hour = \'%s\' and %s " \
            ...
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,country,province,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s and %s = %s" \
                              " and %s = %s" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], fact_table, bid_val,
                ...
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,country,province,hour,count(distinct did) as uv from %s where " \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,country,province,hour,count(distinct did) as uv from %s " \
                              "where bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' and " \
        ...
        if 'ap' not in rtb_list:
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,count(distinct did) as uv from %s " \
                              "where bid = %s and year = \'%s\' and month = \'%s\' and " \
                              "day = \'%s\' and %s = %s and %s = %s and %s = %s and %s = %s " \
                              "and %s = %s" \
                ...
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,%s,hour,count(distinct did) as uv from %s " \
                              "where bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' " \
                              "and hour =  \'%s\' and %s = %s and %s = %s  and %s = %s and %s = %s" \
                              % (rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], fact_table,
                                 bid_val, str(d_date[1:5]), str(d_date[5:7]), str(d_date[7:9]),
                                 str(d_date[9:-1]), rtb_list[2], bny_val, rtb_list[3], cny_val,
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,hour,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and hour = \'%s\' and %s " \
            ...
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,country,province,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s and %s = %s and %s = %s" \
                              % (rtb_list[2], rtb_list[3], rtb_list[4], fact_table, bid_val, str(d_date[1:5]),
                                 str(d_date[5:7]), str(d_date[7:-1]), rtb_list[2], bny_val,
                                 rtb_list[3], cny_val, rtb_list[4], dny_val)
                    f_sql_e = "group by bid,%s,%s,%s,country,province order by bid,%s,%s,%s,country,province asc;" \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,country,province,count(distinct did) as uv " \
                              "from %s where bid = %s and year = \'%s\' and month = \'%s\' and " \
                              "day = \'%s\' and %s = %s and %s = %s and %s = %s and %s = %s" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], fact_table, bid_val,
                                 str(d_date[1:5]), str(d_date[5:7]), str(d_date[7:-1]),
                                 rtb_list[1], any_val, rtb_list[2], bny_val, rtb_list[3],
                                 cny_val, rtb_list[4],dny_val)
                    f_sql_e = "group by bid,%s,%s,%s,%s,country,province order by bid,%s,%s," \
                              "%s,%s,country,province asc;" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4],
                                 rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4])
            else:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,country,province,hour,count(distinct did) as uv from %s where " \
                              "bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' " \
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,country,province,hour,count(distinct did) as uv from %s " \
                              "where bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' and " \
        ...
        if 'ap' not in rtb_list:
            if 'day' in rtb_list:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s " \
                              "and %s = %s and %s = %s and %s = %s  and %s = %s" \
                              % (rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], rtb_list[6], fact_table, bid_val,
                                 str(d_date[1:5]), str(d_date[5:7]), str(d_date[7:-1]), rtb_list[2],
                                 bny_val, rtb_list[3], cny_val, rtb_list[4], dny_val, rtb_list[5],
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,%s,count(distinct did) as uv from %s where bid = %s and " \
                              "year = \'%s\' and month = \'%s\' and day = \'%s\' and %s = %s and %s = %s " \
                              "and %s = %s and %s = %s and %s = %s and %s = %s" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5],
                                 rtb_list[6], fact_table, bid_val, str(d_date[1:5]),
                                 str(d_date[5:7]), str(d_date[7:-1]), rtb_list[1],
                                 any_val, rtb_list[2], bny_val, rtb_list[3], cny_val,
                ...
                if rtb_list[1] == 'bid':
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,%s,hour,count(distinct did) as uv from %s" \
                              " where bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' " \
                              "and hour = \'%s\' and %s = %s and %s = %s and %s = %s and %s = %s " \
                              "and %s = %s and %s = %s" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5],
                                 rtb_list[6], fact_table, bid_val, str(d_date[1:5]),
                                 str(d_date[5:7]), str(d_date[7:9]), str(d_date[9:-1]), rtb_list[1],
                                 any_val, rtb_list[2], bny_val, rtb_list[3], cny_val, rtb_list[4],
                                 dny_val, rtb_list[5], eny_val, rtb_list[6], fny_val)
                ...
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,%s,country,province,count(distinct did) as uv " \
                              ...
                              % (rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], fact_table,
                                 ...
                                 rtb_list[2], bny_val, rtb_list[3], cny_val, rtb_list[4],
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,country,province,count(distinct did) as uv " \
                              "from %s where bid = %s and year = \'%s\' and month = \'%s\' and " \
                              "day = \'%s\' and %s = %s and %s = %s and %s = %s and %s = %s and %s = %s" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], fact_table, bid_val,
                                 str(d_date[1:5]), str(d_date[5:7]), str(d_date[7:-1]),
                                 rtb_list[1], any_val, rtb_list[2], bny_val, rtb_list[3], cny_val,
                                 rtb_list[4], dny_val, rtb_list[5], eny_val)
                    f_sql_e = "group by bid,%s,%s,%s,%s,%s,country,province order by bid,%s,%s," \
                              "%s,%s,%s,country,province asc;" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5],
                                 rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5])
            else:
                if rtb_list[1] == 'bid':
                    f_sql_f = "select bid,%s,%s,%s,%s,country,province,hour,count(distinct did) as uv " \
                              "from %s where bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' " \
                              "and hour = \'%s\' and %s = %s and %s = %s and %s = %s and %s = %s" \
                              % (rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], fact_table, bid_val,
                                 str(d_date[1:5]), str(d_date[5:7]), str(d_date[7:9]), str(d_date[9:-1]),
                    ...
                    if 'sid' in tb:
                        ...
                        rtb_list[1] = "bdid"
                    f_sql_f = "select bid,%s,%s,%s,%s,%s,country,province,hour,count(distinct did) as uv from %s " \
                              "where bid = %s and year = \'%s\' and month = \'%s\' and day = \'%s\' and " \
                              ...
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], fact_table, bid_val,
                                 ...
                                 str(d_date[9:-1]), rtb_list[1], any_val, rtb_list[2],
                                 bny_val, rtb_list[3], cny_val, rtb_list[4], dny_val, rtb_list[5], eny_val)
                    f_sql_e = "group by bid,hour,%s,%s,%s,%s,country,province,%s order by bid,hour,%s,%s,%s,%s," \
                              "country,province,%s asc;" \
                              % (rtb_list[1], rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5], rtb_list[1],
                                 rtb_list[2], rtb_list[3], rtb_list[4], rtb_list[5])
